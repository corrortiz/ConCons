...
public class BusquedaUsuarioController implements Initializable {
    ...
    @FXML private Button bttNuevaCita;
     ...
     */
    public void datePickerFormatoPrimerTap(){
    ...
    public void modificaPaciente(){
        ...
        if (paciente != null) {
            ...
            aux.alertaError("Selecciona un paciente", "Selecciona un paciente", 
                    "Se debe seleccionar un paciente para ser modificado");
        }
    }
    
    /**
     * lanza nueva cita para este paciente
     */
    @FXML
    public void crearNuevaCita(){
        Paciente paciente = tbPaciente.getSelectionModel().getSelectedItem();
        if (paciente != null) {
            palnel.lanzaNuevoCita(paciente);
        }else{
            aux.alertaError("Selecciona un paciente", "Selecciona un paciente", 
                    "Se debe seleccionar un paciente para ser modificado");
        }
    ...
    public void borrarPaciente(){
        ...
        if (paciente != null) {
            ...
            aux.alertaError("Selecciona un paciente", "Selecciona un paciente", 
                    "Se debe seleccionar un paciente para ser borrardo");
        }
    }
